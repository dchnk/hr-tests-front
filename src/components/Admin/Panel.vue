...
<template>
  <div class="panel">
    <div class="text">Вакансии раздела “Разработка и тестирование”</div>
    <div class="container">


      <div class="add">Создать вакансию
      ...
      <div class="btn edit">
        ...
        <div class="tooltip">Редактировать вакансии раздела</div>
      </div>
      <div class="btn archive">
        ...
        <div class="tooltip">Архивировать вакансии раздела</div>
      </div>
      <div class="btn delete">
        ...
        <div class="tooltip">Удалить вакансии раздела</div>
      </div>
